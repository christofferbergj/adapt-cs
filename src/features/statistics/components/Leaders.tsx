      ...
      {leaders.length > 0 ? (
        <div className="mt-6 flex flex-col divide-y divide-gray-6">
          {leaders.map((leader, index) => {
            const color = getPlacementColor(index + 1)
            ...
            return (
              ...
              >
                <div className="relative">
                  {color && (
                    <div className="absolute -right-2 -bottom-1 z-10 w-8">
                      <div className="absolute top-1/2 left-1/2 z-10 -mt-px ml-[0.5px] -translate-y-1/2 -translate-x-1/2 font-mono text-xs text-black">
                        {index + 1}
                      </div>
                ...
                <div className="flex flex-col leading-none">
                  ...
                  <span className="mt-0.5 font-mono text-2xl font-bold text-gray-12">
